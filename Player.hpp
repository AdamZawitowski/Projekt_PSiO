...
public:
    ...
    static constexpr float HITBOX_H = 105.f;
    ...
    std::optional<sf::Vector2f> getLastBrickHit() const { return m_lastBrickHit; }
    void clearLastBrickHit() { m_lastBrickHit = std::nullopt; }
